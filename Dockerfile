...
# renovate: datasource=repology depName=alpine_3_16/gcc versioning=loose
ENV GCC_VERSION="12.2.1_git20220924-r10"
# renovate: datasource=repology depName=alpine_3_16/g++ versioning=loose
ENV GPP_VERSION="12.2.1_git20220924-r10"
# renovate: datasource=repology depName=alpine_3_16/zip versioning=loose
ENV ZIP_VERSION="3.0-r12"
# renovate: datasource=repology depName=alpine_3_16/rsync versioning=loose
